...
if ispc
    ...
    mex(mexargs_json{:}, '-I/opt/homebrew/Cellar/json-c/0.17/include/json-c', '-L/opt/homebrew/lib', '-ljson-c', 'fromjson.c')
    mex(mexargs_json{:}, '-I/opt/homebrew/Cellar/json-c/0.17/include/json-c', '-L/opt/homebrew/lib', '-ljson-c', '-lm', 'tojson.c')
